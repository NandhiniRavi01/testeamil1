...
function AdminPanel() {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      const response = await fetch('http://65.1.129.37:5000/auth/admin/users', {
        method: 'GET',
        credentials: 'include'
      });
  ...
  const handleCreateUser = async () => {
    ...
    try {
      const response = await fetch('http://65.1.129.37:5000/auth/admin/create-user', {
        method: 'POST',
  ...
  const handleUpdateRole = async (userId, newRole) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`http://65.1.129.37:5000/auth/admin/users/${userId}/role`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
  ...
  const handleToggleUser = async (userId, currentStatus, username) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`http://65.1.129.37:5000/auth/admin/users/${userId}/toggle`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
