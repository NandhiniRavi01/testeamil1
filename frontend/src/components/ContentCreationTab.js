...
const ContentCreationTab = ({ setGlobalLoading }) => {
    ...
    const analyzeManualContent = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/content-creation/analyze', {
                method: 'POST',
    ...
    const generateWithAI = async () => {
        ...
        try {
            const response = await fetch('http://localhost:5000/content-creation/generate', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
                body: JSON.stringify({
    ...
    const applyRefinement = async (suggestion) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/content-creation/refine', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
                body: JSON.stringify({
