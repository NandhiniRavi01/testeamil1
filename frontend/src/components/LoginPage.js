...
function LoginPage({ onLogin, onBackToHome }) {
  ...
  const [resetEmail, setResetEmail] = useState("");
    ...
    const checkExistingAuth = async () => {
      try {
        const response = await fetch('https://emailagent.cubegtp.com/api/auth/check-auth', {
          method: 'GET',
          credentials: 'include',
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://emailagent.cubegtp.com/api/${endpoint}`, {
        method: "POST",
        headers: {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch("https://emailagent.cubegtp.com/api/auth/forgot-password", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
